...
public class SequenceStore implements SequenceHandler, KeywordHandler {
  ...
  /**
   * Adding or replacing a special sequence, comment or string.
   *
   ...
   * @return  the previously version of the given property or <code>null</code>
   */
  public TokenizerProperty insertMapped(char startChar, TokenizerProperty property) {
...
public void publicInsertMapped(char c, TokenizerProperty tp) {
	// TODO Auto-generated method stub
	insertMapped('a', tp);
}


public void publicCompare(String string, String string2, int i) {
	// TODO Auto-generated method stub
	compare(string,string2,i);
}


public void publicComparePrefix(String string, DataProvider dp, int i) {
	// TODO Auto-generated method stub
	comparePrefix(string, dp, 0);
}
