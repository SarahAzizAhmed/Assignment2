...
public void publicMapCharacterSet(Map m1, String string, boolean b) {
	// TODO Auto-generated method stub
	mapCharacterSet(m1, string, false);
}

public void publicEscapeChar(char c) {
	// TODO Auto-generated method stub
	escapeChar(c);
}

public void publicAddRange(StringBuffer sb, char c, char d) {
	// TODO Auto-generated method stub
	addRange(sb,c,d);
}

public void publicMergeSet(String string, String string2, boolean b) {
	// TODO Auto-generated method stub
	mergeSet(string,string2,b);
}

public Object publicNormalizeFlags(int i, int j) {
	// TODO Auto-generated method stub
	int flags;
	flags=normalizeFlags( i,  j);
	return flags;
}

public void publicCheckArgument(String string, String string2) {
	// TODO Auto-generated method stub
	checkArgument(string,string2);
}

public void publicCheckPropertyArgument(TokenizerProperty tp2) {
	// TODO Auto-generated method stub
	checkPropertyArgument(tp2);
}

public void publicHandleEvent(int i, String string, String string2) {
	// TODO Auto-generated method stub
	handleEvent(i, string, string2);
}
}
